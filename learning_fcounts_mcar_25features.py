...
if __name__ == "__main__":
    ...
    reps = 30  #number of episodes to train learner on
    num_fcount_rollouts = 100
    eval_rollouts = 100  
    skip_time = 25 #number of episodes to skip when computing demo feature counts
    mwal_iter = 2 #number of times to run MWAL
    rbf_grid_size = 8  
    ...
    EPSILON = 0
    discount = 0.999 #using no discount factor for now
