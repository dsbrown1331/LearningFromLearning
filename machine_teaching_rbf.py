...
if __name__ == "__main__":
    ...
    threshold = 0.001
    horizon = 1
    env = gym.make('MountainCarUniform-v0')
    ...
    fh = open("mcar_rbf3_" + str(num_samples) + ".txt","a")
    ...
    for i in range(reps):
        ...
        for i in range(num_samples):
            ...
            half_planes = get_feature_half_planes(fMap, env, start_state, valueFunction, horizon, min_margin, discount, threshold) #return dictionary s:constraints
            #print(half_planes)
        ...
        fh.write(str(len(opt_start_states)) + "\n")
    fh.close()
